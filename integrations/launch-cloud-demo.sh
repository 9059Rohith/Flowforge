#!/usr/bin/env bash
# Launch the full FlowForge multi-base / multi-forge demo on Ollama Cloud models.
...
#   - forges: gitea + forgejo (Docker) + optional user-owned GitHub remote
#   - FlowForge web UI                                        :8787  -> http://127.0.0.1:8787
#
...
docker start flowforge-gitea flowforge-forgejo >/dev/null 2>&1 || echo "  (run docker compose in forges/ if these don't exist)"
...
echo
echo "  FlowForge -> http://127.0.0.1:8787"
