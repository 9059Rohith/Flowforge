...
Verified in this workspace with stable Rust 1.98.1 using the GNU Windows toolchain: formatting, clippy with `-D warnings`, 60 unit tests, and the optimized release build all pass. Browser and integration syntax checks are documented in [`docs/REPOSITORY_AUDIT.md`](docs/REPOSITORY_AUDIT.md).
